class Processor::Processor < ActiveRecord::Base
  ...
  has_one :processor_performance, :class_name => 'Processor::Performance'
  belongs_to :processor_memory, :class_name => 'Processor::Memory'
  has_one :processor_graphic, :class_name => 'Processor::Graphic'
  has_one :processor_advanced_technology, :class_name => 'Processor::AdvancedTechnology'
  has_one :processor_data_protection, :class_name => 'Processor::DataProtection'
  has_one :processor_expansion, :class_name => 'Processor::Expansion'
  has_one :processor_package, :class_name => 'Processor::Package'
  has_one :processor_platform_protection, :class_name => 'Processor::PlatformProtection'
  ...
  attr_accessor :processor_graphics, :graphics_base_frequency_in_MHz, :graphics_max_dynamic_frequency_GHz, :graphics_video_max_memory_in_GB, :quick_sync_video, :wireless_display, :clear_video_hd_technology, :no_of_display_supported
