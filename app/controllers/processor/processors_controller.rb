class Processor::ProcessorsController < ApplicationController
  ...
  def processor_graphic_params
    params.require(:processor_processor).permit(:processor_graphics, :graphics_base_frequency_in_MHz, :graphics_max_dynamic_frequency_GHz, :graphics_video_max_memory_in_GB, :quick_sync_video, :wireless_display, :clear_video_hd_technology, :no_of_displays_supported)
  end
