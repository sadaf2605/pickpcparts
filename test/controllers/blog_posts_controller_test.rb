...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { avatar: @blog_post.avatar, blogit_posts_id: @blog_post.blogit_posts_id, build_id: @blog_post.build_id }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { avatar: @blog_post.avatar, blogit_posts_id: @blog_post.blogit_posts_id, build_id: @blog_post.build_id }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
